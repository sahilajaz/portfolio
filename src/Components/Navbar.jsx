...
const Navbar = () => {
  ...
  return (
    <nav className='w-full p-7 flex justify-between relative'>
      ...
      {toggle && (
        <ul className='absolute top-20  right-6 flex flex-col items-center font-bold text-[1.2rem] cursor-pointer mt-2 bg-gradient-to-b from-[#19376D] to-[#19376D]/80 border border-[#19376D] p-4 w-40'>
